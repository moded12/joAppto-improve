              ...
              children: [
                PageView.builder(
                  ...
                  itemBuilder: (context, position) {
                    int mPos = position;
                    String imgUrl =
                        IMG_BASE_URL + widget.allSeasons[position].server;
  ...
  Future<void> _shareImage(int index) async {
    try {
      if (_pageController != null) {
        ...
        final file = await File('${tempDir.path}/page$mPage$extension').writeAsBytes(bytes.buffer.asUint8List());

        await Share.shareXFiles(
          [XFile(file.path, mimeType: 'image/$extension')],
