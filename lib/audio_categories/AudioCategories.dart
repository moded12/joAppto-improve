...
import '/audio_categories/PlayAudio.dart';
...
class _AudioCategoriesState extends State<AudioCategories> {
  ...
  showData() {
            ...
            builder: (BuildContext context, AsyncSnapshot snapshot) {
              if (snapshot.hasData) {
                if (snapshot.data != null) {
                  AudioCategories.homeScreenStr = snapshot.data.toString();
    ...
    ChewieAudioDemo();
                                          ...
                                          var count =
                                              allSeasons[index]['count'];
                                          var img_url =
                                              allSeasons[index]['img_url'];
                                          var format =
                                              allSeasons[index]['format'];
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                              builder: (context) {
