...
import '/Model/BookPartsOnlineApi.dart';
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            if (snapshot.data != null) {
              ...
              booksPartsList = BookPartsOnlineApi.fromJson(data).books;
              return Column(
                children: [
                  Expanded(
