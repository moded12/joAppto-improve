    ...
    switch (type) {
      case 'rate_us':
        if (Platform.isAndroid) {
          inAppReview.openStoreListing(appStoreId: "" + AdManager.packageName);
        } else {
          inAppReview.openStoreListing(appStoreId: "" + AdManager.packageName);
        }
        break;
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  Row(
                    children: <Widget>[
                      Icon(icon, color: AdManager.getTextColor()),
                      Padding(padding: const EdgeInsets.all(8.0)),
                      Text(
                        text,
                        style: GoogleFonts.roboto(
                  ...
                  Icon(Icons.arrow_forward, color: AdManager.getTextColor()),
                ],
              ),
            ),
          ),
