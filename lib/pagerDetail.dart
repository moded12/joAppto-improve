...
class _MyPageViewOnlineState extends State<MyPageViewOnline> {
  ...
  Future<void> shareImageWithText(Uint8List imageBytes, int mPage, BuildContext context) async {
    final tempDir = await getTemporaryDirectory();
    final filePath = '${tempDir.path}/page$mPage.png';
  ...
  Future<void> _shareImage() async {
    try {
      if (_pageController != null) {
        ...
        await shareImageWithText(bytes.buffer.asUint8List(), mPage, context);
