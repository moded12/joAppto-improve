...
class _MyPageViewOfflineState extends State<MyPageViewOffline> {
  ...
  Future<void> shareImage(Uint8List imageBytes, BuildContext context) async {
    final tempDir = await getTemporaryDirectory();
    final file = await File('${tempDir.path}/share.png').writeAsBytes(imageBytes);
    ...
    await Share.shareXFiles(
      ...
      text: 'Please download this amazing app: ${AdManager.shareUrl}',
      sharePositionOrigin: box!.localToGlobal(Offset.zero) & box.size, // iPad-like config
    );
  }
  Future<void> _shareImage() async {
    try {
      if (_pageController != null) {
        ...
        await shareImage(bytes.buffer.asUint8List(), context);
        ...
        return AlertDialog(
          ...
          content: TextField(
            decoration: new InputDecoration(
              labelText: "Enter your page number",
            ),
