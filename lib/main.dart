...
import '/BookSection/StartScreen.dart';
import '/AdManager.dart';
import '/PushNotification.dart';
import '/apiConstants.dart';
import '/audio_categories/AudioCategories.dart';
import '/audio_categories/QuranReciters.dart';
import '/books_categories/BooksCategories.dart';
import '/books_categories/OnlineBooksFirebase.dart';
import '/books_categories/ReadQuran.dart';
import '/services.dart';
import '/tasbeeh.dart';
import '/video_categories/VideoCategories.dart';
import '/wallpapers_categories/WallpaperCategories.dart';
import '/youtube_categories/PlayListVideos.dart';
...
// الشاشات الجديدة
import 'screens/choose_section_screen.dart';
    ...
    RestartWidget(
      child: MaterialApp(
        ...
        routes: {
          ...
          '/choose_section': (context) => const ChooseSectionScreen(),
          '/loadAppLaunchData': (context) => loadAppLaunchData(),
          '/section2': (context) => const Section2Screen(),
        },
      ),
    ),
  );
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void initState() {
    ...
    Timer(
      Duration(seconds: 3),
          () => Navigator.of(context).pushReplacementNamed('/choose_section'),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        // Removed broken/empty actions and unnecessary brackets
        actions: [],
      ),
      body: TabBarViews(), // This assumes TabBarViews is a valid widget in your code
    );
  }
}
...
class _TabBarViewsState extends State<TabBarViews> {
  ...
  Future<void> _checkAdRemovalStatus() async {
    try {
      ...
      if (purchaserInfo.entitlements.active.containsKey(
        'ad_removal_entitlement',
      )) {
        setState(() {
          if (box != null) {
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              bottom: TabBar(
                ...
                tabs: [
                  Tab(text: "المعلم الالكتروني الشامل"),
                  Tab(text: "القرآن الكريم"),
                ],
              ),
              title: Center(
                child: SizedBox.shrink(), // ✅ لا يعرض شيء ويتجنب الخطأ
              ),
            ...
            child: Column(
              ...
              children: [
                TabBar(
                  ...
                  indicatorColor: AdManager.getTextColor(),
                  tabs: [Tab(text: "Read Quran"), Tab(text: "Listen Quran")],
                ),
              ],
            ),
          ),
                                  ...
                                  onTap: () {
                                    ...
                                    switch (type) {
                                      ...
                                      case 'youtube_videos':
                                        ...
                                        String api_url =
                                        allSeasons[index]['api_url'];
                                        if (id.isNotEmpty && id.contains("1")) {
                                          String requestURL =
                                              "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=" +
                                                  api_url +
                                                  "&key=AIzaSyDQ_ebWYPb4ajXCitVjQy9CbMMMv9RVubk";
                                      ...
                                      title: Padding(
                                        ...
                                        child: Text(
                                          ...
                                          style: GoogleFonts.cairo(
                                            textStyle: TextStyle(
                                              color:
                                              AdManager.getNeumorphicBackgroundColor(),
                                              fontSize: 16.0,
                                            ),
                                          ),
                                        ),
