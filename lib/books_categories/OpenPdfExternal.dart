...
class OpenPdfExternal extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Expanded(child: PDFViewerCachedFromUrl(url: serverUrl)),
...
class PDFViewerFromUrl extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('PDF From Url')),
...
class PDFViewerFromAsset extends StatelessWidget {
  PDFViewerFromAsset({required Key key, required this.pdfAssetPath})
    : super(key: key);
