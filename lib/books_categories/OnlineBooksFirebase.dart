...
import '/Model/BooksApiFirebase.dart';
import '/books_categories/BookPartsOnline.dart';
...
class _OnlineBooksFirebaseState extends State<OnlineBooksFirebase> {
  ...
  showData() {
    ...
    if (quranreciters != null && quranreciters.isNotEmpty) {
      ...
      widget.booksList = BooksApiFirebase.fromJson(convertedJson).books;
        ...
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          if (snapshot.hasData) {
            if (snapshot.data != null) {
              OnlineBooksFirebase.MORE_BOOKS_RESPONSE =
