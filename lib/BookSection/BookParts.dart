...
import '/Model/BookCollection.dart';
...
class _BookPartsState extends State<BookParts> {
  bool isloaded = false;
  getData() async {
    String response = await DefaultAssetBundle.of(
      context,
    ).loadString("assets/book_content.json");

    var data = json.decode(response);
    widget.radiosList = BookCollection.fromJson(data).dashboard;
    isloaded = true;
    setState(() {});
  }
